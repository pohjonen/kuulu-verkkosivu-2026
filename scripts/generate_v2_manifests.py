...
MODULE_MANIFEST = [
    ...
    },
    {
        ...
        "required_fields": ["section_tag", "heading", "cards"],
        "optional_fields": ["intro_text"],
        "build_wave": 1,
    ...
    },
    {
        ...
        "required_field_groups": ["content", "cta", "media", "layout", "style", "advanced"],
        "required_fields": ["heading", "cards"],
        "optional_fields": ["intro_text", "card_media", "card_micro_cta"],
        "build_wave": 1,
    ...
    },
    {
        ...
        "required_field_groups": ["content", "cta", "layout", "style", "advanced"],
        "required_fields": ["heading", "left_audience_block", "right_audience_block"],
        "optional_fields": ["conclusion_text"],
        "build_wave": 2,
    ...
    },
    {
        ...
        "required_field_groups": ["content", "layout", "style", "advanced"],
        "required_fields": ["stat_items"],
        "optional_fields": ["section_tag", "heading"],
        "build_wave": 2,
    ...
    },
    {
        ...
        "required_field_groups": ["content", "cta", "media", "layout", "style", "advanced"],
        "required_fields": ["heading", "case_cards"],
        "optional_fields": ["intro_text", "tag_filters"],
        "build_wave": 2,
    ...
    },
    {
        ...
        "required_fields": ["section_tag", "heading", "intro_text", "model_cards"],
        "optional_fields": [],
        "build_wave": 3,
    ...
    },
    {
        ...
        "required_field_groups": ["content", "layout", "style", "advanced"],
        "required_fields": ["heading", "agenda_items"],
        "optional_fields": ["intro_text"],
        "build_wave": 3,
    ...
    },
    {
        ...
        "required_field_groups": ["content", "layout", "style", "advanced"],
        "required_fields": ["heading", "faq_items"],
        "optional_fields": [],
        "build_wave": 3,
    ...
    },
    {
        ...
        "required_field_groups": ["content", "media", "layout", "style", "advanced"],
        "required_fields": ["heading", "people"],
        "optional_fields": [],
        "build_wave": 3,
    ...
    },
    {
        ...
        "used_on": ["company-info-v2"],
        "required_field_groups": ["content", "cta", "layout", "style", "advanced"],
        "required_fields": ["office_cards"],
        "optional_fields": ["billing_info_rich_text", "meeting_link", "form_id"],
        "build_wave": 3,
